...
const EntryEditor = ({
  ...
  return (
    <EditorBlock>
      ...
      <Holder>
        <OptionTitleHolder>참가 대회</OptionTitleHolder>
        <OptionBodyHolder>
      ...
      <Holder>
        <OptionTitleHolder>GitHub</OptionTitleHolder>
        <OptionBodyHolder>
          <StyledInput
      ...
      <Holder>
        <OptionTitleHolder>시연 동영상 등록 여부</OptionTitleHolder>
        <OptionBodyHolder>
          <form>
          ...
          <Holder>
            ...
            <OptionBodyHolder>
              <StyledInput
                ...
                value={videoURL}
              />
              <p style={{ color: "red" }}>※ 유튜브 동영상 ID란?</p>
              <p>
